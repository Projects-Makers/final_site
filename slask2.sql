...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 14, 2025 at 07:22 AM
...
(6, 'Częstochowa', 224000, 159.70000, 19.124700, 50.811800, 'Częstochowa to miasto w południowej Polsce, znane z klasztoru na Jasnej Górze, który jest jednym z najważniejszych ośrodków pielgrzymkowych w kraju.', 1),
(7, 'Rybnik', 140000, 148.40000, 18.538700, 50.097500, 'Rybnik to miasto w południowej Polsce, znane z przemysłowego charakteru oraz bliskości do pięknych terenów zielonych i jezior.', 1),
(8, 'Jastrzębie-Zdrój', 96000, 86.80000, 18.600300, 49.974200, 'Jastrzębie-Zdrój to miasto w południowej Polsce, znane z przemysłu węglowego oraz uzdrowiskowego charakteru, szczególnie w dziedzinie rehabilitacji.', 1),
(9, 'Bielsko-Biała', 170000, 124.60000, 19.048100, 49.822300, 'Bielsko-Biała to miasto w południowej Polsce, znane z przemysłu włókienniczego, a także z pięknych górskich krajobrazów i bliskości do Beskidu Śląskiego.', 1),
(10, 'Chorzów\r\n', 109000, 33.20000, 18.966200, 50.300300, 'Chorzów to miasto w południowej Polsce, znane z przemysłu węglowego, a także z jednego z największych parków miejskich w kraju i Śląskiego Wesołego Miasteczka', 1);
