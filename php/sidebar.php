...
<aside class="sidebar">
    ...
    <div class="icon"><img src="icons/map.png" alt="Map" id="mapModalButton"></div>
...
if (isset($_SESSION['username'])) {
    ...
    echo '<div class="icon"><a href="index.php?strona=profil"><img src="icons/user.png" alt="Map"></a></div>';
}
?>
